...
from lerobocasa.utils.errors import PlacementError, SamplingError
import lerobocasa.macros as macros
import lerobocasa.utils.object_utils as OU
from lerobocasa.utils.placement_samplers import (
    SequentialCompositeSampler,
    UniformRandomSampler,
)

from lerobocasa.models.objects.objects import MJCFObject
...
def get_current_layout_stool_rotations(env):
    ...
    """
    from lerobocasa.models.scenes.scene_registry import get_layout_path
...
def _get_placement_initializer(env, cfg_list, z_offset=0.01):
    ...
    def has_auxiliary_pair(cfg_list, name):
        from lerobocasa.models.fixtures.fixture import Fixture
...
def create_obj(env, cfg):
    ...
    if "info" in cfg:
        ...
        new_base_path = os.path.join(lerobocasa.models.assets_root, "objects")
