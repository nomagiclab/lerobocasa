...
from lerobocasa.utils.robomimic.robomimic_dataset_utils import convert_to_robomimic_format
...
def gather_demonstrations_as_hdf5(
    ...
    grp.attrs["robocasa_version"] = lerobocasa.__version__
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--directory",
        type=str,
        default=os.path.join(lerobocasa.models.assets_root, "demonstrations_private"),
    )
    ...
    parser.add_argument(
        "--split", type=str, default="pretrain", choices=["pretrain", "target", "all"]
    )
