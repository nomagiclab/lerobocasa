...
import lerobocasa.utils.model_zoo.file_utils as FileUtils
import lerobocasa.utils.model_zoo.parser_utils as ParserUtils
import lerobocasa.utils.model_zoo.log_utils as LogUtils
...
if __name__ == "__main__":
    ...
    output_path = args.output_path or os.path.join(
        os.path.dirname(lerobocasa.__file__), "models/assets/model_zoo_assets", model_name
    )
