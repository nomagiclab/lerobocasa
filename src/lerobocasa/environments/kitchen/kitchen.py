...
import lerobocasa.utils.camera_utils as CamUtils
import lerobocasa.utils.env_utils as EnvUtils
import lerobocasa.utils.object_utils as OU
import lerobocasa.models.scenes.scene_registry as SceneRegistry
from lerobocasa.models.scenes import KitchenArena
from lerobocasa.models.fixtures import *
import lerobocasa.models.fixtures.fixture_utils as FixtureUtils
from lerobocasa.models.objects.kitchen_object_utils import (
    sample_kitchen_object,
)
from lerobocasa.utils.texture_swap import (
    get_random_textures,
...
from lerobocasa.utils.config_utils import refactor_composite_controller_config
from lerobocasa.utils.errors import PlacementError
from lerobocasa.models.objects.kitchen_objects import OBJ_GROUPS, OBJ_CATEGORIES
from lerobocasa.models.fixtures.fixture_utils import fixture_is_type
from lerobocasa.models.fixtures import FixtureType
import re
...
class KitchenEnvMeta(EnvMeta):
    """Metaclass for registering lerobocasa environments"""
...
class Kitchen(ManipulationEnv, metaclass=KitchenEnvMeta):
    ...
    def edit_model_xml(self, xml_str):
        ...
        robocasa_path_split = os.path.split(lerobocasa.__file__)[0].split("/")

        # replace lerobocasa-specific asset paths
