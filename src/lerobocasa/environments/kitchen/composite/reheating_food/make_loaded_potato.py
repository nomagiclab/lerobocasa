from lerobocasa.environments.kitchen.kitchen import *
...
class MakeLoadedPotato(Kitchen):
    ...
    def _check_success(self):
        gripper_far = (
            OU.gripper_obj_far(self, "potato")
            and OU.gripper_obj_far(self, "condiment")
            and OU.gripper_obj_far(self, "cheese")
        )
        objects_in_place = (
            OU.check_obj_in_receptacle(self, "potato", "cutting_board")
            and OU.check_obj_in_receptacle(self, "condiment", "cutting_board")
            and OU.check_obj_in_receptacle(self, "cheese", "cutting_board")
        )
