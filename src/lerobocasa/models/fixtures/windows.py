...
import lerobocasa
from lerobocasa.models.fixtures import Fixture, WallAccessory
from lerobocasa.models.objects.objects import MujocoXMLObjectRobocasa
import robosuite.utils.transform_utils as T

from lerobocasa.utils.object_utils import get_pos_after_rel_offset
...
class WindowProcBase(CompositeBodyObject):
    ...
    def __init__(
        ...
        self.texture = xml_path_completion(texture, lerobocasa.models.assets_root)
        self.window_bak = xml_path_completion(window_bak, lerobocasa.models.assets_root)
...
class Window(WallAccessory):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.window_bkg = xml_path_completion(window_bkg, lerobocasa.models.assets_root)
