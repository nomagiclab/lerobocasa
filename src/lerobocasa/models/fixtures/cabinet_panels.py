...
import lerobocasa
from lerobocasa.models.objects import MujocoXMLObject
from lerobocasa.models.fixtures.fixture import get_texture_name_from_file
from lerobocasa.models.fixtures.handles import *
from lerobocasa.utils.object_utils import set_geom_dimensions
...
class CabinetPanel(MujocoXMLObject):
    ...
    def __init__(
        ...
        super().__init__(
            xml_path_completion(xml, root=lerobocasa.models.assets_root),
            name=name,
            joints=None,
    ...
    def _set_texture(self):
        ...
        self.texture = xml_path_completion(
            self.texture, root=lerobocasa.models.assets_root
        )
    ...
    def __init__(
        ...
        super().__init__(
            xml_path_completion(
                ...
                root=lerobocasa.models.assets_root,
            ),
            name=name,
            joints=None,
            duplicate_collision_geoms=True,
