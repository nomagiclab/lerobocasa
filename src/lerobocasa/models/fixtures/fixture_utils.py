...
def fixture_is_type(fixture, fixture_type):
    ...
    if fixture_type == FixtureType.SINK:
        ...
        if not isinstance(fixture, Counter):
            return False
        # if island_only is True, this should be considered an island
        if hasattr(fixture, "island_only") and fixture.island_only:
            return True
        # fallback to name-based check
        return "island" in fixture.name
    ...
    #     return isinstance(fixture, Counter) and "corner" not in fixture.name
        ...
        if not cls_check:
            return False
        # if island_only is True, this should NOT be considered a dining counter
        if hasattr(fixture, "island_only") and fixture.island_only:
            return False
